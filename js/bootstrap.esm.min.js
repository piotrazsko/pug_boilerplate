...
function bootstrapDelegationHandler(e, t, n) {
  return function i(o) {
    for (
      var r = e.querySelectorAll(t), s = o.target;
      s && s !== this;
      s = s.parentNode
    )
  ...
  Alert = (function (e) {
    ...
    return (
      ...
      (n._removeElement = function (e) {
        var t = this;
        if (
          (e.classList.remove(CLASS_NAME_SHOW),
          e.classList.contains(CLASS_NAME_FADE))
        ) {
    ...
    return (
      ...
      (n._addTouchEventListeners = function () {
        var e = this,
          t = function (t) {
            !e._pointerEvent ||
            (t.pointerType !== POINTER_TYPE_PEN &&
              t.pointerType !== POINTER_TYPE_TOUCH)
      ...
      (n._keydown = function (e) {
        /input|textarea/i.test(e.target.tagName) ||
          (e.key === ARROW_LEFT_KEY
            ...
            : e.key === ARROW_RIGHT_KEY &&
              (e.preventDefault(), isRTL ? this.prev() : this.next()));
      }),
      ...
      (n._setActiveIndicatorElement = function (e) {
        if (this._indicatorsElement) {
          var t = SelectorEngine.findOne(
            SELECTOR_ACTIVE,
            this._indicatorsElement
          );
          t.classList.remove(CLASS_NAME_ACTIVE$1),
            t.removeAttribute("aria-current");
          for (
            var n = SelectorEngine.find(
                SELECTOR_INDICATOR,
                this._indicatorsElement
              ),
              i = 0;
            ...
            if (
              ...
              n[i].classList.add(CLASS_NAME_ACTIVE$1),
      ...
      (n._slide = function (e, t) {
        ...
        if (r && r.classList.contains(CLASS_NAME_ACTIVE$1))
          this._isSliding = !1;
    ...
    return (
      ...
      (n.hide = function () {
        if (
          ...
          EventHandler.trigger(this._element, EVENT_HIDE$1, e)
            .defaultPrevented ||
      ...
      (t.clearMenus = function (e) {
        if (
          ...
          for (
            var t = SelectorEngine.find(SELECTOR_DATA_TOGGLE$2),
              n = 0,
              i = t.length;
            n < i;
            n++
    ...
    return (
      ...
      (n.show = function (e) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          this._element.classList.contains(CLASS_NAME_FADE$1) &&
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          if (!t.defaultPrevented && i) {
            ...
            if (this.tip.classList.contains(CLASS_NAME_FADE$2)) {
              ...
              EventHandler.one(this.tip, "transitionend", u),
        ...
        if (this._popper) {
          ...
          if (
            ...
            if (
              ...
              EventHandler.one(t, "transitionend", n),
    ...
    return (
      (n.show = function () {
        ...
        if (
          ...
          var r = t
            ? EventHandler.trigger(t, EVENT_HIDE$3, {
      ...
      (n._transitionComplete = function (e, t, n) {
        ...
        e.classList.add(CLASS_NAME_ACTIVE$3),
          ...
          reflow(e),
          e.classList.contains(CLASS_NAME_FADE$4) &&
            e.classList.add(CLASS_NAME_SHOW$6),
          e.parentNode &&
